...
A few other default fields omitted, such as the namespace.
...
You can find more examples in the unit tests, and more documentation on function
docstrings in the src code.
